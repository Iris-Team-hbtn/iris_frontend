...
export const Header = () => {
  ...
  return (
    <>
      ...
      <div ref={featuresRef} style={{ position: 'relative', top: '49px', width: '50vw', minWidth: '380px', padding: '1%', backgroundColor: '#333699' }}>
        <h1>Key Features</h1>
        <video width="75%" controls poster="/assets/video_poster.jpg">
      ...
      <div ref={aboutUsRef} style={{ position: 'relative', top: '49px', width: '50vw', minWidth: '380px', padding: '1%', backgroundColor: '#1f3685' }}>
        <h1>About Us</h1>
